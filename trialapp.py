...
def get_file_path():
    """Get the full path to 'DAILY JOB 2023.xlsx' in the specified directory."""
    # if directory:
    #     return os.path.join(directory, ')
    return "DAILY JOB 2023.xlsx"
...
# Set the directory manually here instead of using Tkinter
